      ...
      <ScrollView>
        <View className="flex-col w-full px-5 mt-[70px]">
          ...
          <View className="flex-col w-full items-center">
            ...
            />
            <Text className="text-[18px] text-[#ff8d08] font-nunitosans-bold mb-[14px]">
              Ankit Roy Chowdhury
            </Text>
            ...
            <View className="flex-col w-full bg-white px-7 py-7 rounded-lg mb-4">
            ...
            <View className="w-full flex-row justify-center mt-12 gap-4 mb-12">
              <TouchableOpacity
                className="border border-[#ff8d08] bg-[#ff8d08] px-[16px] py-2 rounded-lg flex-row items-center gap-3"
